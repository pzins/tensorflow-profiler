...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_init");
  decltype(hsa_init) *orig = (decltype(hsa_init)*) dlsym(RTLD_NEXT, "hsa_init");
  hsa_status_t retval = orig();
  tracepoint(hsa_runtime, runtime_initialized, "queue_profiling");
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_init");
  return retval;
}

hsa_status_t hsa_shut_down()
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_shut_down");
  decltype(hsa_shut_down) *orig = (decltype(hsa_shut_down)*) dlsym(RTLD_NEXT, "hsa_shut_down");
  hsa_status_t retval = orig();
  tracepoint(hsa_runtime, runtime_shut_down, "queue_profiling");
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_shut_down");
  return retval;
}

// hsa_status_t hsa_system_get_info(hsa_system_info_t attribute, void *value)
// {
//   tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_system_get_info");
...
//   tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_system_get_info");
//   return retval;
// }
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_extension_get_name");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_extension_get_name");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_system_extension_supported");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_system_extension_supported");
  return retval;
}
...
hsa_status_t hsa_system_major_extension_supported(uint16_t extension,
                                                            ...
                                                            uint16_t* version_minor, bool* result)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_system_major_extension_supported");
  ...
  hsa_status_t retval = orig(extension, version_major, version_minor, result);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_system_major_extension_supported");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_system_get_extension_table");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_system_get_extension_table");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_system_get_major_extension_table");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_system_get_major_extension_table");
  return retval;
}
...
hsa_status_t hsa_iterate_agents(hsa_status_t (*callback)(hsa_agent_t agent, void *data),
    void *data)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_iterate_agents");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_iterate_agents");
  return retval;
}
...
hsa_status_t hsa_agent_get_info(hsa_agent_t agent,
    ...
    void *value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_agent_get_info");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_agent_get_info");
  return retval;
}
...
hsa_status_t hsa_agent_get_exception_policies(hsa_agent_t agent,
    ...
    uint16_t *mask)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_agent_get_exception_policies");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_agent_get_exception_policies");
  return retval;
}
...
hsa_status_t hsa_cache_get_info(hsa_cache_t cache, hsa_cache_info_t attribute,
                                          void* value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_cache_get_info");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_cache_get_info");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_agent_iterate_caches");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_agent_iterate_caches");
  return retval;
}
...
hsa_status_t hsa_agent_extension_supported(uint16_t extension, hsa_agent_t agent,
    ...
    uint16_t version_minor, bool *result)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_agent_extension_supported");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_agent_extension_supported");
  return retval;
}
...
hsa_status_t hsa_agent_major_extension_supported(uint16_t extension, hsa_agent_t agent,
                                                           ...
                                                           uint16_t* version_minor, bool* result)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_agent_major_extension_supported");
  ...
  hsa_status_t retval = orig(extension, agent, version_major, version_minor, result);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_agent_major_extension_supported");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_create");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_create");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_soft_queue_create");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_soft_queue_create");
  return retval;
}

hsa_status_t hsa_queue_destroy(hsa_queue_t *queue)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_destroy");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_destroy");
  return retval;
}

hsa_status_t hsa_queue_inactivate(hsa_queue_t *queue)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_inactivate");
  decltype(hsa_queue_inactivate) *orig = (decltype(hsa_queue_inactivate)*) dlsym(RTLD_NEXT, "hsa_queue_inactivate");
  hsa_status_t retval = orig(queue);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_inactivate");
  return retval;
}

uint64_t hsa_queue_load_read_index_scacquire(const hsa_queue_t* queue)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_load_read_index_scacquire");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_load_read_index_scacquire");
  return retval;
}

uint64_t hsa_queue_load_read_index_relaxed(const hsa_queue_t *queue)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_load_read_index_relaxed");
  ...
  uint64_t retval = orig(queue);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_load_read_index_relaxed");
  return retval;
}

uint64_t hsa_queue_load_write_index_scacquire(const hsa_queue_t* queue)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_load_write_index_scacquire");
  ...
  uint64_t retval = orig(queue);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_load_write_index_scacquire");
  return retval;
}

uint64_t hsa_queue_load_write_index_relaxed(const hsa_queue_t *queue)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_load_write_index_relaxed");
  ...
  uint64_t retval = orig(queue);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_load_write_index_relaxed");
  return retval;
}
...
void hsa_queue_store_write_index_relaxed(const hsa_queue_t *queue,
    uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_store_write_index_relaxed");
  ...
  orig(queue, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_store_write_index_relaxed");
}

void hsa_queue_store_write_index_screlease(const hsa_queue_t* queue, uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_store_write_index_screlease");
  ...
  orig(queue, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_store_write_index_screlease");
}

uint64_t hsa_queue_cas_write_index_scacq_screl(const hsa_queue_t* queue,
                                                         uint64_t expected, uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_cas_write_index_scacq_screl");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_cas_write_index_scacq_screl");
  return retval;
}
...
uint64_t hsa_queue_cas_write_index_scacquire(const hsa_queue_t* queue, uint64_t expected,
                                                       uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_cas_write_index_scacquire");
  ...
  uint64_t retval = orig(queue, expected, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_cas_write_index_scacquire");
  return retval;
}
...
uint64_t hsa_queue_cas_write_index_relaxed(const hsa_queue_t *queue,
    ...
    uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_cas_write_index_relaxed");
  ...
  uint64_t retval = orig(queue, expected, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_cas_write_index_relaxed");
  return retval;
}
...
uint64_t hsa_queue_cas_write_index_screlease(const hsa_queue_t* queue, uint64_t expected,
                                                       uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_cas_write_index_screlease");
  ...
  uint64_t retval = orig(queue, expected, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_cas_write_index_screlease");
  return retval;
}

uint64_t hsa_queue_add_write_index_scacq_screl(const hsa_queue_t* queue, uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_add_write_index_scacq_screl");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_add_write_index_scacq_screl");
  return retval;
}

uint64_t hsa_queue_add_write_index_scacquire(const hsa_queue_t* queue, uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_add_write_index_scacquire");
  ...
  uint64_t retval = orig(queue, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_add_write_index_scacquire");
  return retval;
}

uint64_t hsa_queue_add_write_index_relaxed(const hsa_queue_t *queue, uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_add_write_index_relaxed");
  ...
  uint64_t retval = orig(queue, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_add_write_index_relaxed");
  return retval;
}

uint64_t hsa_queue_add_write_index_screlease(const hsa_queue_t* queue, uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_add_write_index_screlease");
  ...
  uint64_t retval = orig(queue, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_add_write_index_screlease");
  return retval;
}
...
void hsa_queue_store_read_index_relaxed(const hsa_queue_t *queue,
    uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_store_read_index_relaxed");
  ...
  orig(queue, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_store_read_index_relaxed");
}

void hsa_queue_store_read_index_screlease(const hsa_queue_t* queue, uint64_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_queue_store_read_index_screlease");
  ...
  orig(queue, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_queue_store_read_index_screlease");
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_agent_iterate_regions");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_agent_iterate_regions");
  return retval;
}
...
hsa_status_t hsa_region_get_info(hsa_region_t region,
    ...
    void *value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_region_get_info");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_region_get_info");
  return retval;
}

hsa_status_t hsa_memory_register(void *address, size_t size)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_memory_register");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_memory_register");
  return retval;
}

hsa_status_t hsa_memory_deregister(void *address, size_t size)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_memory_deregister");
  decltype(hsa_memory_deregister) *orig = (decltype(hsa_memory_deregister)*) dlsym(RTLD_NEXT, "hsa_memory_deregister");
  hsa_status_t retval = orig(address, size);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_memory_deregister");
  return retval;
}

hsa_status_t hsa_memory_allocate(hsa_region_t region, size_t size, void **ptr)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_memory_allocate");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_memory_allocate");
  return retval;
}

hsa_status_t hsa_memory_free(void *ptr)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_memory_free");
  decltype(hsa_memory_free) *orig = (decltype(hsa_memory_free)*) dlsym(RTLD_NEXT, "hsa_memory_free");
  hsa_status_t retval = orig(ptr);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_memory_free");
  return retval;
}

hsa_status_t hsa_memory_copy(void *dst, const void *src, size_t size)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_memory_copy");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_memory_copy");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_memory_assign_agent");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_memory_assign_agent");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_create");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_create");
  return retval;
}

hsa_status_t hsa_signal_destroy(hsa_signal_t signal)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_destroy");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_destroy");
  return retval;
}

hsa_signal_value_t hsa_signal_load_relaxed(hsa_signal_t signal)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_load_relaxed");
...
void hsa_signal_silent_store_relaxed(hsa_signal_t signal, hsa_signal_value_t value)
{
  ...
  orig(signal, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_silent_store_relaxed");
}

void hsa_signal_silent_store_screlease(hsa_signal_t signal, hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_silent_store_screlease");
  ...
  orig(signal, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_silent_store_screlease");
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_wait_relaxed");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_wait_relaxed");
  return retval;
}
...
hsa_signal_value_t hsa_signal_wait_scacquire(hsa_signal_t signal,
                                                       ...
                                                       hsa_wait_state_t wait_expectancy_hint)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_wait_scacquire");
  decltype(hsa_signal_wait_scacquire) *orig = (decltype(hsa_signal_wait_scacquire)*) dlsym(RTLD_NEXT, "hsa_signal_wait_scacquire");
  hsa_signal_value_t retval = orig(signal, condition, compare_value, timeout_hint, wait_expectancy_hint);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_wait_scacquire");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_group_create");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_group_create");
  return retval;
}

hsa_status_t hsa_signal_group_destroy(hsa_signal_group_t signal_group)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_group_destroy");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_group_destroy");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_group_wait_any_scacquire");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_group_wait_any_scacquire");
  return retval;
}
...
hsa_status_t hsa_signal_group_wait_any_relaxed(hsa_signal_group_t signal_group,
                                                         ...
                                                         hsa_signal_value_t* value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_group_wait_any_relaxed");
...
void hsa_signal_subtract_relaxed(hsa_signal_t signal, hsa_signal_value_t value)
{
  ...
  orig(signal, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_subtract_relaxed");
}

void hsa_signal_subtract_scacquire(hsa_signal_t signal, hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_subtract_scacquire");
  ...
  orig(signal, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_subtract_scacquire");
}

void hsa_signal_subtract_screlease(hsa_signal_t signal, hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_subtract_screlease");
  ...
  orig(signal, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_subtract_screlease");
}

void hsa_signal_subtract_scacq_screl(hsa_signal_t signal, hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_subtract_scacq_screl");
  ...
  orig(signal, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_subtract_scacq_screl");
}

hsa_signal_value_t hsa_signal_exchange_relaxed(hsa_signal_t signal, hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_exchange_relaxed");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_exchange_relaxed");
  return retval;
}
...
hsa_signal_value_t hsa_signal_exchange_scacquire(hsa_signal_t signal,
                                                           hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_exchange_scacquire");
  ...
  hsa_signal_value_t retval = orig(signal, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_exchange_scacquire");
  return retval;
}
...
hsa_signal_value_t hsa_signal_exchange_screlease(hsa_signal_t signal,
                                                           hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_exchange_screlease");
  ...
  hsa_signal_value_t retval = orig(signal, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_exchange_screlease");
  return retval;
}
...
hsa_signal_value_t hsa_signal_exchange_scacq_screl(hsa_signal_t signal,
                                                             hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_exchange_scacq_screl");
  ...
  hsa_signal_value_t retval = orig(signal, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_exchange_scacq_screl");
  return retval;
}
...
hsa_signal_value_t hsa_signal_cas_relaxed(hsa_signal_t signal,
    ...
    hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_cas_relaxed");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_cas_relaxed");
  return retval;
}
...
hsa_signal_value_t hsa_signal_cas_scacquire(hsa_signal_t signal,
                                                      ...
                                                      hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_cas_scacquire");
  decltype(hsa_signal_cas_scacquire) *orig = (decltype(hsa_signal_cas_scacquire)*) dlsym(RTLD_NEXT, "hsa_signal_cas_scacquire");
  hsa_signal_value_t retval = orig(signal, expected, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_cas_scacquire");
  return retval;
}
...
hsa_signal_value_t hsa_signal_cas_screlease(hsa_signal_t signal,
                                                      ...
                                                      hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_cas_screlease");
  decltype(hsa_signal_cas_screlease) *orig = (decltype(hsa_signal_cas_screlease)*) dlsym(RTLD_NEXT, "hsa_signal_cas_screlease");
  hsa_signal_value_t retval = orig(signal, expected, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_cas_screlease");
  return retval;
}
...
hsa_signal_value_t hsa_signal_cas_scacq_screl(hsa_signal_t signal,
                                                        ...
                                                        hsa_signal_value_t value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_signal_cas_scacq_screl");
  decltype(hsa_signal_cas_scacq_screl) *orig = (decltype(hsa_signal_cas_scacq_screl)*) dlsym(RTLD_NEXT, "hsa_signal_cas_scacq_screl");
  hsa_signal_value_t retval = orig(signal, expected, value);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_signal_cas_scacq_screl");
  return retval;
}
...
hsa_status_t hsa_isa_from_name(
      ...
      hsa_isa_t *isa)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_isa_from_name");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_isa_from_name");
  return retval;
}
...
hsa_status_t hsa_agent_iterate_isas(
      ...
      void *data)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_agent_iterate_isas");
  decltype(hsa_agent_iterate_isas) *orig = (decltype(hsa_agent_iterate_isas)*) dlsym(RTLD_NEXT, "hsa_agent_iterate_isas");
  hsa_status_t retval = orig(agent, callback, data);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_agent_iterate_isas");
  return retval;
}
...
hsa_status_t hsa_isa_get_info(
      ...
      void *value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_isa_get_info");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_isa_get_info");
  return retval;
}
...
hsa_status_t hsa_isa_get_info_alt(
      ...
      void *value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_isa_get_info_alt");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_isa_get_info_alt");
  return retval;
}
...
hsa_status_t hsa_isa_get_exception_policies(
      ...
      uint16_t *mask)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_isa_get_exception_policies");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_isa_get_exception_policies");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_isa_get_round_method");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_isa_get_round_method");
  return retval;
}
...
hsa_status_t hsa_wavefront_get_info(
      ...
      void *value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_wavefront_get_info");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_wavefront_get_info");
  return retval;
}
...
hsa_status_t hsa_isa_iterate_wavefronts(
      ...
      void *data)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_isa_iterate_wavefronts");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_isa_iterate_wavefronts");
  return retval;
}
...
hsa_status_t hsa_isa_compatible(
      ...
      bool *result)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_isa_compatible");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_isa_compatible");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_code_object_serialize");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_code_object_serialize");
  return retval;
}
...
hsa_status_t hsa_code_object_deserialize(
      ...
      hsa_code_object_t *code_object)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_code_object_deserialize");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_code_object_deserialize");
  return retval;
}
...
hsa_status_t hsa_code_object_destroy(
      hsa_code_object_t code_object)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_code_object_destroy");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_code_object_destroy");
  return retval;
}
...
hsa_status_t hsa_code_object_get_info(
      ...
      void *value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_code_object_get_info");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_code_object_get_info");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_code_object_get_symbol");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_code_object_get_symbol");
  return retval;
}
...
hsa_status_t hsa_code_object_get_symbol_from_name(
      ...
      hsa_code_symbol_t *symbol)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_code_object_get_symbol_from_name");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_code_object_get_symbol_from_name");
  return retval;
}
...
hsa_status_t hsa_code_symbol_get_info(
      ...
      void *value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_code_symbol_get_info");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_code_symbol_get_info");
  return retval;
}
...
hsa_status_t hsa_code_object_iterate_symbols(
      ...
      void *data)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_code_object_iterate_symbols");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_code_object_iterate_symbols");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_code_object_reader_create_from_file");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_code_object_reader_create_from_file");
  return retval;
}
...
hsa_status_t hsa_code_object_reader_create_from_memory(
      ...
      hsa_code_object_reader_t *code_object_reader)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_code_object_reader_create_from_memory");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_code_object_reader_create_from_memory");
  return retval;
}
...
hsa_status_t hsa_code_object_reader_destroy(
      hsa_code_object_reader_t code_object_reader)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_code_object_reader_destroy");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_code_object_reader_destroy");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_create");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_create");
  return retval;
}
...
hsa_status_t hsa_executable_create_alt(
      ...
      hsa_executable_t *executable)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_create_alt");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_create_alt");
  return retval;
}
...
hsa_status_t hsa_executable_destroy(
      hsa_executable_t executable)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_destroy");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_destroy");
  return retval;
}
...
hsa_status_t hsa_executable_load_code_object(
      ...
      const char *options)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_load_code_object");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_load_code_object");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_load_program_code_object");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_load_program_code_object");
  return retval;
}
...
hsa_status_t hsa_executable_load_agent_code_object(
      ...
      hsa_loaded_code_object_t *loaded_code_object)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_load_agent_code_object");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_load_agent_code_object");
  return retval;
}
...
hsa_status_t hsa_executable_freeze(
      ...
      const char *options)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_freeze");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_freeze");
  return retval;
}
...
hsa_status_t hsa_executable_get_info(
      ...
      void *value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_get_info");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_get_info");
  return retval;
}
...
hsa_status_t hsa_executable_global_variable_define(
      ...
      void *address)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_global_variable_define");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_global_variable_define");
  return retval;
}
...
hsa_status_t hsa_executable_agent_global_variable_define(
      ...
      void *address)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_agent_global_variable_define");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_agent_global_variable_define");
  return retval;
}
...
hsa_status_t hsa_executable_readonly_variable_define(
      ...
      void *address)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_readonly_variable_define");
  ...
  hsa_status_t retval = orig(executable, agent, variable_name, address);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_readonly_variable_define");
  return retval;
}
...
hsa_status_t hsa_executable_validate(
      ...
      uint32_t *result)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_validate");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_validate");
  return retval;
}
...
hsa_status_t hsa_executable_validate_alt(
      ...
      uint32_t *result)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_validate_alt");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_validate_alt");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_get_symbol");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_get_symbol");
  return retval;
}
...
hsa_status_t hsa_executable_get_symbol_by_name(
      ...
      hsa_executable_symbol_t *symbol)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_get_symbol_by_name");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_get_symbol_by_name");
  return retval;
}
...
hsa_status_t hsa_executable_symbol_get_info(
      ...
      void *value)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_symbol_get_info");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_symbol_get_info");
  return retval;
}
...
hsa_status_t hsa_executable_iterate_symbols(
      ...
      void *data)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_iterate_symbols");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_iterate_symbols");
  return retval;
}
...
hsa_status_t hsa_executable_iterate_agent_symbols(
      ...
      void *data)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_iterate_agent_symbols");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_iterate_agent_symbols");
  return retval;
}
...
hsa_status_t hsa_executable_iterate_program_symbols(
      ...
      void *data)
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_executable_iterate_program_symbols");
  ...
  hsa_status_t retval = orig(executable, callback, data);
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_executable_iterate_program_symbols");
  return retval;
}
...
{
  tracepoint(hsa_runtime, function_entry, "hsa_api", "hsa_status_string");
  ...
  tracepoint(hsa_runtime, function_exit, "hsa_api", "hsa_status_string");
  return retval;
}